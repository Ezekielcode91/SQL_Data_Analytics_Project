...
(
    ...
    job_work_from_home TINYINT(1), -- Using TINYINT(1) for BOOLEAN
    search_location TEXT,
    job_posted_date TIMESTAMP,
    job_no_degree_mention TINYINT(1), -- Using TINYINT(1) for BOOLEAN
    job_health_insurance TINYINT(1), -- Using TINYINT(1) for BOOLEAN
    job_country TEXT,
    salary_rate TEXT,
    salary_year_avg DECIMAL(10,2), -- Using DECIMAL for NUMERIC
    salary_hour_avg DECIMAL(10,2), -- Using DECIMAL for NUMERIC
